...
class locale {
    ...
    // the message string. If the message cannot be located, then a description
    // of the message and its arguments is returned.
    message(msg, args) {
        ...
        return args && args.length ? `${msg}(${args.join(",")})` : msg;
    }
    ...
    // cannot be located, then the key is returned.
